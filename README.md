...
This project develops a stochastic simulation framework to understand how interest rate paths and prepayment incentives jointly influence the prepayment rates at a mortgage portfolio level.
...
### Distribution of Mortgage Pool Balances

![Pool Balance Paths](./images/pool_balance_paths.png)

The dispersion in balance trajectories highlights the sensitivity of mortgage cashflows to stochastic interest rate evolution. Falling rate environments accelerate prepayments, leading to faster depletion of outstanding balances, while rising rate scenarios result in slower amortisation and extended duration.

The wide percentile band reflects significant uncertainty in cashflow timing, which cannot be captured under deterministic rate assumptions.

---

### CPR Distribution under Different Rate Scenarios

![CPR Distribution](./images/cpr_distribution.png)

The distribution of CPR shifts significantly across rate scenarios. Falling rate environments produce higher average prepayment rates along with greater dispersion, reflecting stronger refinancing incentives. In contrast, rising rate environments suppress prepayment activity.

This non-linear response highlights the importance of modelling stochastic interest rate paths when estimating mortgage cashflows.
